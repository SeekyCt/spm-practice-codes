...
/* 0x0314 */ u16 unknown_0x314;
/* 0x0316 */ u8 pseudoJoystickX;
/* 0x0317 */ u8 pseudoJoystickY;
/* 0x0318 */ u8 unknown_0x318;
/* 0x0319 */ u8 unknown_0x319;
/* 0x031a */ u8 unknown_0x31a;
/* 0x031b */ u8 unknown_0x31b;
/* 0x031c */ u8 unknown_0x31c;
/* 0x031d */ u8 unknown_0x31d;
    /*
...
/* 0x0322 */ u16 certainButtonsPressedMask;
/* 0x0324 */ u16 certainButtonsHeldMask;
/* 0x0326 */ u8 unknown_0x326[0x328 - 0x326];
/* 0x0328 */ float joystickMagnitude;
/* 0x032C */ u8 unknown_0x32c[0x348 - 0x32c];
/* 0x0348 */ s32 sfxIds[4];
/* 0x0358 */ u32 buttonMaskFilter;
/* 0x035c */ u8 unknown_0x35c[0x3a4 - 0x35c];
    /*
